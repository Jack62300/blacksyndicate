 ...
 */
final class Version20190511115815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE site_news (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, contenue VARCHAR(255) NOT NULL, contenue_long LONGTEXT NOT NULL, auteur VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, categorie VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

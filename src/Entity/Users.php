...
class Users
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="job", type="string", length=50, nullable=true, options={"default"="unemployed"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="position", type="string", length=36, nullable=true)
     */
    private $position;
     ...
     * @var bool|null
     *
     * @ORM\Column(name="is_dead", type="boolean", nullable=true)
     */
    private $isDead = '0';
     ...
     * @var string|null
     *
     * @ORM\Column(name="tattoos", type="text", length=0, nullable=true)
     */
    private $tattoos;
